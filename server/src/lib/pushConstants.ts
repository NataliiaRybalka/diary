const en = {
	...
	day_plan: {
		...
		body: (taskData: any) => `The time of the scheduled task is approaching: ${taskData.task} in ${taskData.time}.`,
	},
};
const ru = {
	morning: {
	...
	day_plan: {
		...
		body: (taskData: any) => `Приближается время запланированной задачи: ${taskData.task} в ${taskData.time}.`,
	},
};
const ua = {
	morning: {
	...
	day_plan: {
		...
		body: (taskData: any) => `Наближається час запланованого завдання: ${taskData.task} в ${taskData.time}.`,
	},
};
