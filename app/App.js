    ...
    return (
        <NavigationContainer>
            <Stack.Navigator>
                ...
                />
                <Stack.Screen
                    name="Update Menstrual Cycle"
                    component={UpdateMenstrualCycle}
                    options={{ headerShown: false }}
                />
                <Stack.Screen
                    name="Update Week Plan"
                    component={UpdateWeekPlan}
                    options={{ headerShown: false }}
                />
