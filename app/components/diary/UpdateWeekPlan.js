...
function UpdateWeekPlan({ route }) {
    ...
    const saveWeekPlan = async () => {
        ...
        const endpoint = updatedDay._id
            ? `/week-plan/${updatedDay._id}`
            : `/day-plan/${JSON.parse(user).id}`;
    ...
    return (
        ...
        >
            ...
            <View style={styles.rowBtn}>
                <Text style={styles.newRow} onPress={handleAddRow}>
                    +
                </Text>
                <Text style={styles.newRow} onPress={handleRemoveRow}>
                    -
                </Text>
            </View>
            ...
            {[...Array(rows)].map((row, rowNumber) => (
                <View style={styles.rowUpdate} key={rowNumber}>
                    <TimePicker
                        time={updatedDay.plans[rowNumber]?.time}
                        setTime={setTime}
                        row={rowNumber}
            ...
            <View style={styles.btn}>
                <Text style={styles.btnText} onPress={saveWeekPlan}>
                    {t("Save")}
                </Text>
            </View>
