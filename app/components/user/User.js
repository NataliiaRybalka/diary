        ...
        <View style={[styles.container, { backgroundColor: bgColour }]}>
            ...
            >
                ...
                <View style={styles.btn}>
                    <Text style={styles.btnText} onPress={updateUserData}>
                        {t("Update")}
                    </Text>
                </View>
                ...
                {lang === "en" ? (
                    <>
                        <Text
                            onPress={() =>
                                navigation.navigate("Set up notifications")
                            }
                    ...
                    <>
                        <Text
                            onPress={() =>
                                navigation.navigate("Настройка уведомлений")
                            }
                            style={styles.question}
                        >
                            {t("Set up notifications")}
                        ...
                        <Text
                            onPress={() =>
                                navigation.navigate("Удалить аккаунт")
                            }
                            style={styles.question}
                        >
                            {t("Delete Account")}
                    ...
                    <>
                        <Text
                            onPress={() =>
                                navigation.navigate("Налаштувати сповіщень")
                            }
                            style={styles.question}
                        >
                            {t("Set up notifications")}
                        ...
                        <Text
                            onPress={() =>
                                navigation.navigate("Видалити акаунт")
                            }
                            style={styles.question}
                        >
                            {t("Delete Account")}
