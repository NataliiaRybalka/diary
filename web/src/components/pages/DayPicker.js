        ...
        <div
            className={
                pickerTitle === "startOvulation"
                    ? "pickerContainer datePickerContainer startOvulationDatePickerContainer"
                    : "pickerContainer datePickerContainer"
            }
        >
            <div className="yearContainer">
                <span onClick={() => setSelectedYear(Number(selectedYear) - 1)}>
                    &#60;
                </span>
            ...
            <div className="dayNumContainer">
                {days.map((day) => (
                    <span
                        ...
                        style={{
                            backgroundColor:
                                day === Number(selectedDay) && bgColour,
                        }}
