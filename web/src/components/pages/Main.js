        ...
        <main>
            <Routes>
                ...
                <Route
                    ...
                    element={<RestoringPassword />}
                />
                <Route
                    path="refresh-password/:username"
                    element={<ChangingPassword />}
                />
                <Route
                    path="delete-account"
                    element={<DeletingAccount user={user} />}
                />
                <Route
                    path="notifications"
                ...
                <Route
                    path="/my-diary/month-results"
                    element={<MonthResults />}
                />
                {/* <Route path="/my-diary/results" element={<Results />} /> */}
                <Route
                    path="/my-diary/menstrual-cycle"
                    element={<MenstrualCycle />}
                />

                <Route
                    path="metaphorical-cards"
                    element={
