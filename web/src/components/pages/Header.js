            ...
            <div>
                <nav>
                    <ul>
                        ...
                        {user && (
                            <li className="mainNavLi">
                                <Link to="/metaphorical-cards">
                                    {t("Metaphorical Cards")}
                                </Link>
                            </li>
                        )}
                        <li className="mainNavLi">
                        ...
                        <li className="mainNavLi">
                            ...
                            >
                                ...
                                <option
                                    value="#eebeed"
                                    style={{ backgroundColor: "#eebeed" }}
                                ></option>
                                <option
                                    value="#cae6f7"
                                    style={{ backgroundColor: "#cae6f7" }}
                                ></option>
                                <option
                                    value="#d0fbd9"
                                    style={{ backgroundColor: "#d0fbd9" }}
                                ></option>
                                <option
                                    value="#f1f9b4"
                                    style={{ backgroundColor: "#f1f9b4" }}
                                ></option>
                            </select>
                        </li>
                    </ul>
