...
function MenstrualCycle() {
    ...
    const [showStartOvulationDatePicker, setShowStartOvulationDatePicker] =
        useState(false);
    ...
    return (
        <div>
                        ...
                        <tr key={rowI}>
                            ...
                            <td className="mcTableBodyTdNumber">
                                <input
                                    type="number"
                                    name="durationCycle"
                                    value={tableData[rowI]?.durationCycle}
                                    onChange={(e) => onChangeInput(e, rowI)}
                                />
                            </td>
                            <td className="pickerTd">
                                {showStartOvulationDatePicker ? (
                                    updatedRow === String(rowI) && (
                                        <DayPicker
                                            ...
                                            setShowPicker={
                                                setShowStartOvulationDatePicker
                                            }
            ...
            <button className="submit savePage" onClick={onHandleSave}>
                {t("Save")}
            </button>
        </div>
    );
